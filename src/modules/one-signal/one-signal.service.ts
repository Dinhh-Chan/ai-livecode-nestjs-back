    ...
    async sendNotification(notification: CreateDocument<Notification>) {
        switch (notification.receiverType) {
            case NotificationReceiverType.TOPIC: {
                // TODO: Implement topic-based notification logic
                // Since user-topic relationship is removed, this needs to be reimplemented
                // based on the new topic structure
                console.log("Topic-based notifications not implemented yet");
                break;
            }
